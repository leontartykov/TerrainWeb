        ...
        <>
            ...
            <div className={pageStyle.div_main_page}>
                ...
                <div className={cardStyle.groupCard}>
                    <SearchCard placeholder="Найти проект..." deleteProjIcon="delete" addProjIcon="add_box"
                    ...
                    {props.project1 ? <ProjectCard idDel={props.project1.name} idDownload={props.project1.name} checkbox="y" project={props.project1.name} 
                                                ...
                                                onClickDelete={props.onClickDelete}></ProjectCard>: null}
                    {props.project2 ? <ProjectCard idDel={props.project2.name} idDownload={props.project2.name} checkbox="y" project={props.project2.name}
                                                ...
                                                download="download" delete="delete"
                                                onClickDownload={props.onClickDownload} onClickDelete={props.onClickDelete}></ProjectCard>: null}
                    {props.project3 ? <ProjectCard idDel={props.project3.name} idDownload={props.project3.name} checkbox="y" project={props.project3.name}
